...
def import_model_and_crop(model_name):
    if model_name == 'FCNN3D':
        from SRmodels.FCNN3D import FCNN3D, center_crop
        return FCNN3D, center_crop
    elif model_name == 'MSSR':
        from SRmodels.MSSR import MSSR, center_crop
        return MSSR, center_crop
    elif model_name == 'RDN':
        from SRmodels.RDN import RDN_HSI, center_crop
        return RDN_HSI, center_crop
    elif model_name == 'Transformer':
        from SRmodels.Transformer import HSI_SR_Transformer, center_crop
        return HSI_SR_Transformer, center_crop
    elif model_name == 'PanNet':
        from SRmodels.PanNet import PanNet, center_crop
